...
public class CoIoTe_Taken implements MyTabuSearch {
    ...
    private CoIoTe_ObjectiveFunctionTaken objectiveFunction;
    ...
    public CoIoTe_Taken(int numCells, int numCustTypes, int numTimeSteps, Data data) {
        this.numCells = numCells;
        this.numCustTypes = numCustTypes;
        this.numTimeSteps = numTimeSteps;
        this.data = data;

        objectiveFunction = new CoIoTe_ObjectiveFunctionTaken(data, numCells, numCustTypes, numTimeSteps);
        moveManager = new CoIoTe_MoveManagerTaken(numCells, numCustTypes, numTimeSteps);
	...
	@Override
    public CoIoTe_Taken initSingleThread(Solution sol) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CoIoTe_Taken initMultiThread(Solution sol, int threads) {
        solution = (CoIoTe_Solution) sol;
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CoIoTe_Taken setIterationToGo(int n) {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CoIoTe_Taken startSolving() {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CoIoTe_Taken setUnimprovingMoves(int n) {
